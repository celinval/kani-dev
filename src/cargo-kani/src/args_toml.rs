...
/// Produce a set of arguments to pass to ourself (cargo-kani) from a Cargo.toml project file.
///
...
/// ```
/// [<cfg_kani_args>]* [<cmd_kani_args>]* [--cbmc-args [<cfg_cbmc_args>]* [<cmd_cbmc_args>]*]
/// ```
fn merge_args(
